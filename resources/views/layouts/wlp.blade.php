                        ...
                        <ul class="navbar-nav navbar-nav-right">
                            ...
                            <li class="nav-item nav-profile dropdown">
                                <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"
                                    id="profileDropdown">
                                    <span class="nav-profile-name">{{ auth('wlp')->user()->name }}</span>
            ...
            <nav class="bottom-navbar">
                <div class="container">
                    <ul class="nav page-navigation">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="submenu">
                                <ul>
                                    <li class="nav-item">
                                        <a class="nav-link"
                                            href="{{route('assignedElements.Wlp')}}">Elements
                                            List</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('assigneElements.mfg')}}">Assign
                                            Elements</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('manufacturers') }}" class="nav-link">
                                <i class="mdi mdi-cube-outline menu-icon"></i>
